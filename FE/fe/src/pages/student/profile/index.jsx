...
import { changePasswordService, updateUserProfileService } from "@/services";
...
function StudentProfilePage() {
    ...
    const handleSaveChanges = async () => {
        ...
        try {
            const response = await updateUserProfileService(auth?.user?._id, formData.userName);
            ...
            <div className="max-w-2xl mx-auto">
                ...
                <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <p className="text-sm text-blue-800">
                        <strong>Note:</strong> Your profile information is secure and only visible
                        to you.
                    </p>
                </div>
            </div>
